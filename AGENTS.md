# BaseWethUsdcMomentumStrategy - Agent Guide

> AI coding agent context for the `base_weth_usdc_momentum` strategy.

## Overview

- **Template:** ta_swap
- **Chain:** base
- **Class:** `BaseWethUsdcMomentumStrategy` in `strategy.py`
- **Config:** `config.json`
